...
export default function HomeFooter() {
  return (
    <footer className="md:p-8 pb-6   text-blueLight md:flex-row md:justify-between md:items-center border-t-1 border-t-gray-700 bg-foreground flex flex-col gap-y-6">
      <div className="w-full flex items-center gap-x-6">
        <p className="hidden md:block md:w-fit">© 2025 · H4 Invest</p>
        <p className="hidden md:block">|</p>
        <p className="md:flex items-center gap-x-4 hidden  ">
          <svg
          ...
          phassessoria2@gmail.com
        </p>
      </div>

      <div className="md:flex-row w-full justify-end flex items-center flex-col gap-y-6 gap-x-8">
        <p className="flex items-center gap-x-4 md:hidden">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <Link
          href={'https://www.instagram.com/h4investimentos'}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-x-4 hover:text-gray-400 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-instagram-icon lucide-instagram  size-6"
          >
        ...
        <p className="hidden md:block">|</p>
        <Link
          href={'https://www.instagram.com/pedroheming'}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-x-4 hover:text-gray-400 transition-colors"
        >
      ...
      <div className="w-full justify-center flex md:hidden pt-4">
        <p className="md:hidden  w-fit">© 2025 · H4 Invest</p>
      </div>
    </footer>
  )
}
