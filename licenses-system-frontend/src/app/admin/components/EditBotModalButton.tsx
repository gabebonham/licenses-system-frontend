...
import { createExpert, editExpert } from '../actions/experts.service'
import { Input } from '@/components/ui/input'
import { toast } from 'sonner'

export default function EditBotModalButton({
  btn,
  id,
}: {
  btn: any
  ...
  return (
    <Dialog open={isActive} onOpenChange={activate}>
      ...
      <DialogContent className=" h-3/4 bg-grayLight min-w-5/12 w-full p-2 lg:p-6 z-90   ">
        ...
        <ScrollArea className="lg:flex-row  min-h-7/12 h-full  w-full flex flex-col items-center">
